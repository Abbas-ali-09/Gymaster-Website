...
if ($_SERVER["REQUEST_METHOD"]==="POST") {
    ...
    $check_user = "SELECT * FROM reg_user WHERE username='$username' OR email='$email' LIMIT 1";
    ...
    if ($result -> num_rows > 0) {
        ...
        $sql = "INSERT INTO reg_user (username,email,password,number) VALUES('$username','$email','$password','$number')";
